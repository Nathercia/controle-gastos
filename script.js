...
const campoEntradaOrcamento = document.querySelector(
  '.formularioEntradaOrcamento input'
)

const buttonOrcamento = document.querySelector(
  '.formularioEntradaOrcamento button'
)
...
const campoNomeDespesa = document.querySelector(
  '.formularioEntradaDespesa_nome'
)

const campoValorDespesa = document.querySelector(
  '.formularioEntradaDespesa_valor'
)
...
const orcamento = document.querySelector(
  '.secaoImpressaoResultados_orcamento p'
)
...
const listaDespesas = document.querySelector('.conteinerDespesas_lista')
